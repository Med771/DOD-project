...
# 🎊 Итоги проекта
Заполняется по завершению проекта. Этот документ должен автономен и быть понят человеком, который не видел паспорта проекта.

Прикрепляется ссылка на презентацию по итогам, где есть:
- Выводы/итоги по метрикам и post evaluation
- Проблемами, которые возникли, но не были учтены
